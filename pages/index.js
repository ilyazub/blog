...
const ServiceCard = ({ title, description }) => (
  <motion.div 
    className="p-8 bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 hover:bg-white/10 transition-all"
    whileHover={{ y: -10 }}
  >
    <h3 className="text-2xl mb-4 bg-gradient-to-r from-cyan-400 to-pink-400 bg-clip-text text-transparent">{title}</h3>
